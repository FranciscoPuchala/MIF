...
// ─── RESTAURANTE ─────────────────────────────────────────────────
const restaurantId = 'ElHornoDeJuan';
...
const restaurant = {
  ...
  isOpen: true,
  capacity: 40,
  ownerId: 'N6oEQi7ji3hsvo1mXc6ilGjnXvI3',
  hours: {
...
// ─── MESAS ───────────────────────────────────────────────────────
const tables = [
  { number: 1,  capacity: 2, x: 0, y: 0, isAvailable: true },
  { number: 2,  capacity: 2, x: 1, y: 0, isAvailable: false },
  { number: 3,  capacity: 4, x: 3, y: 0, isAvailable: true },
  { number: 4,  capacity: 4, x: 1, y: 1, isAvailable: true },
  { number: 5,  capacity: 4, x: 2, y: 1, isAvailable: false },
  { number: 6,  capacity: 2, x: 0, y: 2, isAvailable: true },
  { number: 7,  capacity: 6, x: 2, y: 2, isAvailable: true },
  { number: 8,  capacity: 2, x: 3, y: 2, isAvailable: true },
  { number: 9,  capacity: 4, x: 0, y: 3, isAvailable: false },
  { number: 10, capacity: 4, x: 1, y: 3, isAvailable: true },
  { number: 11, capacity: 2, x: 3, y: 3, isAvailable: true },
];
